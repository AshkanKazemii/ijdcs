...
<div class="side-menu">
    <div class="side-menu-body">
        <ul>
            ...
            <li><a class="active" href="{{ route('superadmin.published-article-list') }}"><i class="icon ti-home"></i> <span></span>مقالات منتشر شده</a></li>
        ...
        <div class="page-header">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('superadmin.index') }}">داشبورد</a></li>
                        <li class="breadcrumb-item">لیست مقالات منتشر شده</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <table class="table">
                                ...
                                @foreach ($articles as $article)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ route('superadmin.rejected-article' , $article->id) }}">
                                                @csrf
